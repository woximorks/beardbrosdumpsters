class PricingCardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pricing_card.save
        format.html { redirect_to pricing_card_url(@pricing_card), notice: "Pricing card was successfully created." }
  ...
  def update
    respond_to do |format|
      if @pricing_card.update(pricing_card_params)
        format.html { redirect_to pricing_card_url(@pricing_card), notice: "Pricing card was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pricing_cards_url, notice: "Pricing card was successfully destroyed." }
  ...
  private
    ...
    def pricing_card_params
      params.require(:pricing_card).permit(:pricing_card_title, :pricing_card_description, :pricing_card_image_url, :pricing_card_total_cost)
    end
end
